                ...
                itemBuilder: (context, index) {
                  ...
                  return Stack(
                    children: [
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: const TextStyle(
                                      color: Colors.white, // Text color in badge
                                      fontSize: 12,
                      ...
                      Positioned(
                        right: 10, // Adjust to move the arrow icon outside the container
                        top: 32, // Adjust based on vertical alignment
                        child: Icon(
